--[[
    ZVOLT HUB V2.41 NOSILENT — FRESH EDITION
...
loadSub.TextColor3 = COLOR_SUBTEXT loadSub.Text = "FRESH EDITION • v2.41 NOSILENT" loadSub.Parent = loader
...
logoSub.Text = "FRESH • v2.41 NOSILENT" logoSub.Parent = side
...
createToggle(v1, "Equipos", function(v) settings.teamCheck = v end)
...
createToggle(m3, "AntiCaída", function(v) settings.antiVoid = v end)
...
local tMagic
tMagic = createToggle(w1, "Magia ⚠️", function(v)
            ...
            if nowD - diagLast > 0.25 then
                ...
                if nowD - diagF9Last > 4 then
                    ...
                    dprint(string.format(
                        "[ZVOLT-DIAG] magic=%s tracked=%d acquired=%d trigger=%s shots=%d fov=%d",
...
notify("ZVOLT V2.41 NOSILENT", "Cargado. Usa cuenta alt. RightShift = ocultar.")
dprint("[ZVOLT V2.41 NOSILENT] cargado OK - build sin silent")
